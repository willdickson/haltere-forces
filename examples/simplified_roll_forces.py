...
from haltere_forces.simplified_coriolis import lateral_coriolis_from_roll
...
f_r = lateral_coriolis_from_roll(
        param['mass'], 
        param['length'], 
        param['tilt_angle'], 
        omega_x, 
...
f_l = lateral_coriolis_from_roll(
        param['mass'], 
        param['length'], 
        param['tilt_angle'], 
        omega_x, 
...
ax[3].set_xlim(0, num_cycle*period)
#ax[2].set_xlabel('t (sec)')

fig.tight_layout()
fig.savefig('lateral_roll_coriolis_forces.png')
plt.show()
